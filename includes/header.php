...
?></span></li>          
        ...
        <div class="head-right">
          ...
          <ul class="number">
            ...
            <li><a href="room-history.php">  Room History </a></li>|
    ...
    <div class="header-bottom">
      <div class="container">
        <div class="logo">
          <a href="index.php" style="text-align:center;"><img src="images/logo1.jpg" class="img-responsive" alt="" width="100" height="50" />
