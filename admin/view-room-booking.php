...
if(isset($_POST['submit']))
  {
    ...
    $ressta=$_POST['status'];
    $remark=$_POST['remark'];
   $query=mysqli_query($con, "update   tblroom set Remark='$remark', Status='$ressta' where ID='$viewid'");
    if ($query) {
...
<head>
  ...
  <title>Online Temple Management System || View Room Booking Receipt</title>
  <!-- base:css -->
            ...
            <div class="col-lg-12 stretch-card">
              <div class="card">
                <div class="card-body" id="print2">
                  <h4 class="card-title">Room booking Details</h4>
                 
                  <div class="table-responsive pt-3">
                    <?php
 $viewid=$_GET['id'];
$ret=mysqli_query($con,"select tbluser.ID as uid,tbluser.FirstName,tbluser.LastName,tbluser.MobileNumber,tbluser.Email,
tbluser.RegDate,tbltemple.ID as tid,tbltemple.TempleName,tbltemple.TempleLocation,tbltemple.City as tcity,tbltemple.State 
as tstate,tbltemple.Country as tcountry,tbltemple.Description,tbltemple.TempleImage1,
tblroom.ID as bid,tblroom.BookingNumber,tblroom.UserId,tblroom.TempleID,tblroom.BookingDate,tblroom.CheckinTime,tblroom.TotalMember,tblroom.City as dcity,tblroom.State as dstate,
tblroom.Country as dcountry,tblroom.IdentityProof,tblroom.IdentityProofnumber,tblroom.Message,tblroom.BookingDate,tblroom.Status 
