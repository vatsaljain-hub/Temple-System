...
$totfesti=mysqli_num_rows($query6);
?>
                     <h5 class="text-white font-weight-bold">New Room Booking- <?php echo $totfesti;?></h5>
                      <a href="new-room-booking.php"><p class="mt-2 text-white card-text">View Detail</p></a>
                    </div>
                  </div>
                </div>
              </div>
